        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="container mt-5">
                    <h2> List pages </h2>   
                    <a href="<?= base_url('admin/pages/create')?>" class="btn btn-success mb-2">Add Halaman</a>
                    <div class="row mt-3">
                        <div class="col-sm-12">
                            <table class="table table-striped" id="tableuser">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $page['author']; ?></td>
                                        <td><?= $page['isi']; ?></td>
                                        <td><?= $page['tglposting']; ?></td>
                                        <td>
                                            <a href="<?= base_url('admin/pages/edit/'.$page['id']);?>" class="btn btn-success">Edit</a>
                                            <a href="<?= base_url('admin/pages/delete/'.$page['id']);?>" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                    <?php endif; ?>
